...
public class IntradayFragment extends Fragment {
    ...
    public static IntradayFragment newInstance(){
...
//
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView=inflater.inflate(R.layout.fragment_intraday,null);

        //REFERENCE
        rv = rootView.findViewById(R.id.rv_intraday);
...
//        rv.setAdapter(new RecyclerViewAdapter(getActivity(),PriceTarget));
