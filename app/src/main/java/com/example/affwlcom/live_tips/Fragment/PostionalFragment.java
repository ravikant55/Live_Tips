 ...
 */
public class PostionalFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView=inflater.inflate(R.layout.fragment_postional,null);

        //REFERENCE
        rv = rootView.findViewById(R.id.rv_postional);
